  ...
  <main id="content" role="main">
    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 min-h-[75rem]">
      ...
      <header class="max-w-3xl">
        ...
        <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">Dark Application Layout Navbar/Header using Tailwind CSS</h1>
        <p class="mt-2 text-lg text-gray-800 dark:text-gray-400">This is a simple application layout with header only example using Tailwind CSS.</p>
...
export const AlertError:React.FunctionComponent<AlertProps> = ({ children, ...props}) : any | null => {
  ...
  <main id="content" role="main">
    ...
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 min-h-[75rem]">
      ...
      <header class="max-w-3xl">
        <p class="mb-2 text-sm font-semibold text-blue-600">Starter Pages & Examples</p>
        <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">Application Layout: Header using Tailwind CSS</h1>
        <p class="mt-2 text-lg text-gray-800 dark:text-gray-400">This is a simple application layout with header only example using Tailwind CSS.</p>
        <div class="mt-5 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
          <a class="w-full sm:w-auto inline-flex justify-center items-center gap-x-3 text-center bg-blue-600 hover:bg-blue-700 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition py-3 px-4 dark:focus:ring-offset-gray-800" href="https://github.com/htmlstreamofficial/preline/tree/main/examples/html" target="_blank">
            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
