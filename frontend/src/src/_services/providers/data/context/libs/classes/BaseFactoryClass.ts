import { BaseError, ContractFunctionRevertedError, createPublicClient, createWalletClient, custom, formatEther, getAddress, hashMessage, http, isAddress, parseEther, recoverAddress, recoverMessageAddress, verifyMessage } from 'viem';
...
class BaseFactoryClass {
    ...
    async getBalance(address: `0x${string}`, formartted: boolean = false): Promise<Array<any>> {
    ...
    isReady(): any {
        ...
        return this.isInitialized && this.currentAddress !== '0x0' && this.walletAddress != '0x0';

    }

    async updateClient(abiJSON: any, addressJSON: any, chain: any, walletAddress: `0x${string}`): Promise<any> {
    ...
    async sendTransaction(to: `0x${string}`, amount: number): Promise<`0x${string}`> {
    ...
    async verifyMessage(message: string, signature: `0x${string}` | Uint8Array): Promise<boolean> {
    ...
    async recoverMessageAddress(message: string, signature: `0x${string}` | Uint8Array): Promise<`0x${string}`> {
    ...
    async recoverAddress(hash: `0x${string}`, signature: `0x${string}` | Uint8Array): Promise<`0x${string}`> {
    ...
    watchEvent(eventName: string, callbackSuccess: Function, callbackError: Function): any {
    ...
    async readContract(functionName: string, args: Array<any>, successCallback: Function, errorCallback: Function, finalCallback: Function): Promise<any> {
    ...
    async writeContract(functionName: string, args: Array<any>, successCallback: Function, errorCallback: Function, finalCallback: Function): Promise<any> {
    ...
    async writeContractViem(functionName: string, args: Array<any>, successCallback: Function, errorCallback: Function, finalCallback: Function): Promise<any> {
