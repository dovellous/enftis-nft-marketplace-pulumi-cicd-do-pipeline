...
export class BidStatusMySQLDBCls extends MySQLTableCls {

    // Table name for this model : BidStatus
    ...
    constructor() {
		...
		// 	sequelize: this.mySQLInstance, // We need to pass the connection instance
		// 	modelName: 'BidStatusMySQLDBCls' // We need to choose the model name
		//   });
