...
class NftsObjCls {
	...
	fid: string;
	nft_address: string;
	nft_auction_meta: any;
	nft_chains: any;
	nft_collection_meta: any;
	nft_created_at: string;
	nft_description: string;
	nft_gallery: any;
	nft_hash: string;
	nft_id: number;
	nft_interface_id: string;
	nft_interface_type: string;
	nft_ipfs_id: string;
	nft_is_auction: boolean;
	nft_link: string;
	nft_meta: any;
	nft_minted: boolean;
	nft_name: string;
	...
	nft_pricing: any;
	nft_properties: any;
	nft_royalty_amount: number;
	nft_royalty_receiver: string;
	nft_sensitive_content: boolean;
	nft_supply: number;
	nft_support_royalties: boolean;
	nft_symbol: string;
	nft_unlockable: boolean;
	nft_updated_at: string;
	nft_uuid: string;
  ...
  constructor(
	...
	_fid: string, 
	_nft_address: string, 
	_nft_auction_meta: any, 
	_nft_chains: any, 
	_nft_collection_meta: any, 
	_nft_created_at: string, 
	_nft_description: string, 
	_nft_gallery: any, 
	_nft_hash: string, 
	_nft_id: number, 
	_nft_interface_id: string, 
	_nft_interface_type: string, 
	_nft_ipfs_id: string, 
	_nft_is_auction: boolean, 
	_nft_link: string, 
	_nft_meta: any, 
	_nft_minted: boolean, 
	_nft_name: string, 
	...
	_nft_pricing: any, 
	_nft_properties: any, 
	_nft_royalty_amount: number, 
	_nft_royalty_receiver: string, 
	_nft_sensitive_content: boolean, 
	_nft_supply: number, 
	_nft_support_royalties: boolean, 
	_nft_symbol: string, 
	_nft_unlockable: boolean, 
	_nft_updated_at: string, 
	_nft_uuid: string, 
	_token_creator: string, 
	_token_id: number, 
	_token_minter: string, 
	_user_id: number
  ) {
	this.category_id = _category_id;
	this.fid = _fid;
	this.nft_address = _nft_address;
	this.nft_auction_meta = _nft_auction_meta;
	this.nft_chains = _nft_chains;
	this.nft_collection_meta = _nft_collection_meta;
	this.nft_created_at = _nft_created_at;
	this.nft_description = _nft_description;
	this.nft_gallery = _nft_gallery;
	this.nft_hash = _nft_hash;
	this.nft_id = _nft_id;
	this.nft_interface_id = _nft_interface_id;
	this.nft_interface_type = _nft_interface_type;
	this.nft_ipfs_id = _nft_ipfs_id;
	this.nft_is_auction = _nft_is_auction;
	this.nft_link = _nft_link;
	this.nft_meta = _nft_meta;
	this.nft_minted = _nft_minted;
	this.nft_name = _nft_name;
	this.nft_preview = _nft_preview;
	this.nft_price = _nft_price;
	this.nft_pricing = _nft_pricing;
	this.nft_properties = _nft_properties;
	this.nft_royalty_amount = _nft_royalty_amount;
	this.nft_royalty_receiver = _nft_royalty_receiver;
	this.nft_sensitive_content = _nft_sensitive_content;
	this.nft_supply = _nft_supply;
	this.nft_support_royalties = _nft_support_royalties;
	this.nft_symbol = _nft_symbol;
	this.nft_unlockable = _nft_unlockable;
	this.nft_updated_at = _nft_updated_at;
	this.nft_uuid = _nft_uuid;
	this.token_creator = _token_creator;
	this.token_id = _token_id;
	this.token_minter = _token_minter;
  ...
  toString() {
    return `
		...
		nft_auction_meta='${this.nft_auction_meta}'; 
		nft_chains='${this.nft_chains}'; 
		nft_collection_meta='${this.nft_collection_meta}'; 
		nft_created_at='${this.nft_created_at}'; 
		nft_description='${this.nft_description}'; 
		nft_gallery='${this.nft_gallery}'; 
		nft_hash='${this.nft_hash}'; 
		nft_id='${this.nft_id}'; 
		nft_interface_id='${this.nft_interface_id}'; 
		nft_interface_type='${this.nft_interface_type}'; 
		nft_ipfs_id='${this.nft_ipfs_id}'; 
		nft_is_auction='${this.nft_is_auction}'; 
		nft_link='${this.nft_link}'; 
		nft_meta='${this.nft_meta}'; 
		nft_minted='${this.nft_minted}'; 
		nft_name='${this.nft_name}'; 
		nft_preview='${this.nft_preview}'; 
		nft_price='${this.nft_price}'; 
		nft_pricing='${this.nft_pricing}'; 
		nft_properties='${this.nft_properties}'; 
		nft_royalty_amount='${this.nft_royalty_amount}'; 
		nft_royalty_receiver='${this.nft_royalty_receiver}'; 
		nft_sensitive_content='${this.nft_sensitive_content}'; 
		nft_supply='${this.nft_supply}'; 
		nft_support_royalties='${this.nft_support_royalties}'; 
		nft_symbol='${this.nft_symbol}'; 
		nft_unlockable='${this.nft_unlockable}'; 
		nft_updated_at='${this.nft_updated_at}'; 
		nft_uuid='${this.nft_uuid}'; 
		token_creator='${this.token_creator}'; 
		token_id='${this.token_id}'; 
		token_minter='${this.token_minter}'; 
...
const nftsConverter = {
  toFirestore: (nftsData: NftsObjCls): DocumentData => {
    return {
		category_id: nftsData.category_id,
		fid: nftsData.fid,
		nft_address: nftsData.nft_address,
		nft_auction_meta: nftsData.nft_auction_meta,
		nft_chains: nftsData.nft_chains,
		nft_collection_meta: nftsData.nft_collection_meta,
		nft_created_at: nftsData.nft_created_at,
		nft_description: nftsData.nft_description,
		nft_gallery: nftsData.nft_gallery,
		nft_hash: nftsData.nft_hash,
		nft_id: nftsData.nft_id,
		nft_interface_id: nftsData.nft_interface_id,
		nft_interface_type: nftsData.nft_interface_type,
		nft_ipfs_id: nftsData.nft_ipfs_id,
		nft_is_auction: nftsData.nft_is_auction,
		nft_link: nftsData.nft_link,
		nft_meta: nftsData.nft_meta,
		nft_minted: nftsData.nft_minted,
		nft_name: nftsData.nft_name,
		nft_preview: nftsData.nft_preview,
		nft_price: nftsData.nft_price,
		nft_pricing: nftsData.nft_pricing,
		nft_properties: nftsData.nft_properties,
		nft_royalty_amount: nftsData.nft_royalty_amount,
		nft_royalty_receiver: nftsData.nft_royalty_receiver,
		nft_sensitive_content: nftsData.nft_sensitive_content,
		nft_supply: nftsData.nft_supply,
		nft_support_royalties: nftsData.nft_support_royalties,
		nft_symbol: nftsData.nft_symbol,
		nft_unlockable: nftsData.nft_unlockable,
		nft_updated_at: nftsData.nft_updated_at,
		nft_uuid: nftsData.nft_uuid,
		token_creator: nftsData.token_creator,
		token_id: nftsData.token_id,
		token_minter: nftsData.token_minter,
		user_id: nftsData.user_id,
    };
  },
  fromFirestore: (
    ...
    return new NftsObjCls(
		data.category_id, 
		data.fid, 
		data.nft_address, 
		data.nft_auction_meta, 
		data.nft_chains, 
		data.nft_collection_meta, 
		data.nft_created_at, 
		data.nft_description, 
		data.nft_gallery, 
		data.nft_hash, 
		data.nft_id, 
		data.nft_interface_id, 
		data.nft_interface_type, 
		data.nft_ipfs_id, 
		data.nft_is_auction, 
		data.nft_link, 
		data.nft_meta, 
		...
		data.nft_pricing, 
		data.nft_properties, 
		data.nft_royalty_amount, 
		data.nft_royalty_receiver, 
		data.nft_sensitive_content, 
		data.nft_supply, 
		data.nft_support_royalties, 
		data.nft_symbol, 
		data.nft_unlockable, 
		data.nft_updated_at, 
		data.nft_uuid, 
...
// Begin Class: NftsFirebaseCls

export class NftsFirebaseCls extends FirebaseCollectionCls {

  // Collection name for the model : Nfts
  ...
  constructor() {
    ...
    this.collectionName = 'Nfts';

    // Init model name
    this.modelName = this.collectionName;

    this.setupCollection(this.modelName, nftsConverter);
