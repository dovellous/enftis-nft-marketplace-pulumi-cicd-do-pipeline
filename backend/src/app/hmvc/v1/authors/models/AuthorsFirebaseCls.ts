...
class AuthorsObjCls {
	...
	author_sold_items: number;
	author_sold_value: any;
  ...
  constructor(
	_author_created_at: string, 
	_author_id: number, 
	_author_is_active: boolean, 
	_author_is_verified: boolean, 
	_author_rating: number, 
	_author_sold_items: number, 
	_author_sold_value: any, 
	_author_updated_at: string, 
	_author_uuid: string, 
	_category_id: number, 
	_fid: string, 
	_user_id: number
  ) {
	this.author_created_at = _author_created_at;
	this.author_id = _author_id;
	this.author_is_active = _author_is_active;
	this.author_is_verified = _author_is_verified;
	this.author_rating = _author_rating;
	this.author_sold_items = _author_sold_items;
	this.author_sold_value = _author_sold_value;
	this.author_updated_at = _author_updated_at;
	this.author_uuid = _author_uuid;
  ...
  toString() {
    return `
		author_created_at='${this.author_created_at}'; 
		author_id='${this.author_id}'; 
		author_is_active='${this.author_is_active}'; 
		author_is_verified='${this.author_is_verified}'; 
		author_rating='${this.author_rating}'; 
		author_sold_items='${this.author_sold_items}'; 
		author_sold_value='${this.author_sold_value}'; 
		author_updated_at='${this.author_updated_at}'; 
...
const authorsConverter = {
  toFirestore: (authorsData: AuthorsObjCls): DocumentData => {
    return {
		author_created_at: authorsData.author_created_at,
		author_id: authorsData.author_id,
		author_is_active: authorsData.author_is_active,
		author_is_verified: authorsData.author_is_verified,
		author_rating: authorsData.author_rating,
		author_sold_items: authorsData.author_sold_items,
		author_sold_value: authorsData.author_sold_value,
		author_updated_at: authorsData.author_updated_at,
		author_uuid: authorsData.author_uuid,
		category_id: authorsData.category_id,
		fid: authorsData.fid,
		user_id: authorsData.user_id,
    };
  },
  fromFirestore: (
    ...
    return new AuthorsObjCls(
		data.author_created_at, 
		data.author_id, 
		data.author_is_active, 
		data.author_is_verified, 
		data.author_rating, 
		data.author_sold_items, 
		data.author_sold_value, 
		data.author_updated_at, 
		data.author_uuid, 
		data.category_id, 
		data.fid, 
		data.user_id
...
// Begin Class: AuthorsFirebaseCls

export class AuthorsFirebaseCls extends FirebaseCollectionCls {

  // Collection name for the model : Authors
  ...
  constructor() {
    ...
    this.setupCollection(this.modelName, authorsConverter);
