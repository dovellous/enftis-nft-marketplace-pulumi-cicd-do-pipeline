...
export class FavouriteCollectionsMySQLDBCls extends MySQLTableCls {

    // Table name for this model : FavouriteCollections
...
// End Class: FavouriteCollectionsMySQLDBCls