...
export class InviteLinksMySQLDBCls extends MySQLTableCls {

    // Table name for this model : InviteLinks
    private databaseTable: string = 'tbl_invite_links';
...
// End Class: InviteLinksMySQLDBCls