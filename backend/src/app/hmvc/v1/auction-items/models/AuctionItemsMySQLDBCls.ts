...
export class AuctionItemsMySQLDBCls extends MySQLTableCls {

    // Table name for this model : AuctionItems
    private databaseTable: string = 'tbl_auction_items';
...
// End Class: AuctionItemsMySQLDBCls