...
class UsersObjCls {
  ...
  constructor(
	...
	_fid: string, 
	_firebase_provider_data: any, 
	_first_name: string, 
	_last_name: string, 
	_organization_id: number, 
	_password: string, 
	_phone_number: string, 
	_phone_number_verified: string, 
	_photo_url: string, 
	_socket_id: string, 
	_supabase_provider: any, 
	_user_access_levels: any, 
	_user_country: string, 
	_user_created_at: string, 
	_user_default_role: string, 
	_user_dob: string, 
	_user_gender: string, 
	_user_id: number, 
	_user_is_active: boolean, 
	_user_last_login: string, 
	_user_last_seen: string, 
	_user_updated_at: string, 
	_user_uuid: string, 
	_username: string
  ) {
	this.email = _email;
	this.email_verified = _email_verified;
	this.fid = _fid;
	this.firebase_provider_data = _firebase_provider_data;
	this.first_name = _first_name;
	this.last_name = _last_name;
	this.organization_id = _organization_id;
	this.password = _password;
	this.phone_number = _phone_number;
	this.phone_number_verified = _phone_number_verified;
	this.photo_url = _photo_url;
	this.socket_id = _socket_id;
	this.supabase_provider = _supabase_provider;
	this.user_access_levels = _user_access_levels;
	this.user_country = _user_country;
	this.user_created_at = _user_created_at;
	this.user_default_role = _user_default_role;
	this.user_dob = _user_dob;
	this.user_gender = _user_gender;
	this.user_id = _user_id;
	this.user_is_active = _user_is_active;
	this.user_last_login = _user_last_login;
	this.user_last_seen = _user_last_seen;
	this.user_updated_at = _user_updated_at;
	this.user_uuid = _user_uuid;
  ...
  toString() {
    return `
		...
		fid='${this.fid}'; 
		firebase_provider_data='${this.firebase_provider_data}'; 
		...
		supabase_provider='${this.supabase_provider}'; 
		user_access_levels='${this.user_access_levels}'; 
		user_country='${this.user_country}'; 
		user_created_at='${this.user_created_at}'; 
		user_default_role='${this.user_default_role}'; 
		user_dob='${this.user_dob}'; 
		user_gender='${this.user_gender}'; 
		user_id='${this.user_id}'; 
		user_is_active='${this.user_is_active}'; 
		user_last_login='${this.user_last_login}'; 
		user_last_seen='${this.user_last_seen}'; 
...
const usersConverter = {
  toFirestore: (usersData: UsersObjCls): DocumentData => {
    return {
		email: usersData.email,
		email_verified: usersData.email_verified,
		fid: usersData.fid,
		firebase_provider_data: usersData.firebase_provider_data,
		first_name: usersData.first_name,
		last_name: usersData.last_name,
		organization_id: usersData.organization_id,
		password: usersData.password,
		phone_number: usersData.phone_number,
		phone_number_verified: usersData.phone_number_verified,
		photo_url: usersData.photo_url,
		socket_id: usersData.socket_id,
		supabase_provider: usersData.supabase_provider,
		user_access_levels: usersData.user_access_levels,
		user_country: usersData.user_country,
		user_created_at: usersData.user_created_at,
		user_default_role: usersData.user_default_role,
		user_dob: usersData.user_dob,
		user_gender: usersData.user_gender,
		user_id: usersData.user_id,
		user_is_active: usersData.user_is_active,
		user_last_login: usersData.user_last_login,
		user_last_seen: usersData.user_last_seen,
		user_updated_at: usersData.user_updated_at,
		user_uuid: usersData.user_uuid,
  ...
  fromFirestore: (
    ...
    return new UsersObjCls(
		data.email, 
		data.email_verified, 
		data.fid, 
		data.firebase_provider_data, 
		data.first_name, 
		data.last_name, 
...
// Begin Class: UsersFirebaseCls

export class UsersFirebaseCls extends FirebaseCollectionCls {

  // Collection name for the model : Users
  ...
  constructor() {
    ...
    this.setupCollection(this.modelName, usersConverter);
