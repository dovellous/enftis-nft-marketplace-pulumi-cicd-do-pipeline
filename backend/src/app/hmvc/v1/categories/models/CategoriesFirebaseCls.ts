...
class CategoriesObjCls {
  ...
  constructor(
	_category_created_at: string, 
	_category_icon: string, 
	_category_id: number, 
	_category_is_active: boolean, 
	_category_name: string, 
	_category_parent_id: number, 
	_category_slug: string, 
	_category_updated_at: string, 
	_category_uuid: string, 
	_fid: string
  ) {
	this.category_created_at = _category_created_at;
	this.category_icon = _category_icon;
	this.category_id = _category_id;
	this.category_is_active = _category_is_active;
	this.category_name = _category_name;
	this.category_parent_id = _category_parent_id;
	this.category_slug = _category_slug;
	this.category_updated_at = _category_updated_at;
	this.category_uuid = _category_uuid;
	this.fid = _fid;
  }
...
const categoriesConverter = {
  toFirestore: (categoriesData: CategoriesObjCls): DocumentData => {
    return {
		category_created_at: categoriesData.category_created_at,
		category_icon: categoriesData.category_icon,
		category_id: categoriesData.category_id,
		category_is_active: categoriesData.category_is_active,
		category_name: categoriesData.category_name,
		category_parent_id: categoriesData.category_parent_id,
		category_slug: categoriesData.category_slug,
		category_updated_at: categoriesData.category_updated_at,
		category_uuid: categoriesData.category_uuid,
		fid: categoriesData.fid,
    };
  },
  fromFirestore: (
    ...
    return new CategoriesObjCls(
		data.category_created_at, 
		data.category_icon, 
		data.category_id, 
		data.category_is_active, 
		data.category_name, 
...
// Begin Class: CategoriesFirebaseCls

export class CategoriesFirebaseCls extends FirebaseCollectionCls {

  // Collection name for the model : Categories
  ...
  constructor() {
    ...
    this.setupCollection(this.modelName, categoriesConverter);
...
// End Class: CategoriesFirebaseCls