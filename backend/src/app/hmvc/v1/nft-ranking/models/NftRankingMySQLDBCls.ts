...
export class NftRankingMySQLDBCls extends MySQLTableCls {

    // Table name for this model : NftRanking
    private databaseTable: string = 'tbl_nft_ranking';
...
// End Class: NftRankingMySQLDBCls